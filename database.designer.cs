...
namespace Quan_Li_Tiem_Net
{
	...
	public partial class TaiKhoan : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<decimal> _SoDuTien;
		
		private System.Nullable<double> _SoDuThoiGianGiay;
		
		private System.Nullable<decimal> _TongTienDaNap;
		
		private System.Nullable<double> _TongGiayDaMua;
    ...
    partial void OnSoDuTienChanging(System.Nullable<decimal> value);
    partial void OnSoDuTienChanged();
    partial void OnSoDuThoiGianGiayChanging(System.Nullable<double> value);
    partial void OnSoDuThoiGianGiayChanged();
    partial void OnTongTienDaNapChanging(System.Nullable<decimal> value);
    partial void OnTongTienDaNapChanged();
    partial void OnTongGiayDaMuaChanging(System.Nullable<double> value);
    partial void OnTongGiayDaMuaChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SoDuTien", DbType="Decimal(18,2)")]
		public System.Nullable<decimal> SoDuTien
		{
			get
			{
				return this._SoDuTien;
			}
			set
			{
				if ((this._SoDuTien != value))
				{
					this.OnSoDuTienChanging(value);
					this.SendPropertyChanging();
					this._SoDuTien = value;
					this.SendPropertyChanged("SoDuTien");
					this.OnSoDuTienChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SoDuThoiGianGiay", DbType="Float")]
		public System.Nullable<double> SoDuThoiGianGiay
		{
			get
			{
				return this._SoDuThoiGianGiay;
			}
			set
			{
				if ((this._SoDuThoiGianGiay != value))
				{
					this.OnSoDuThoiGianGiayChanging(value);
					this.SendPropertyChanging();
					this._SoDuThoiGianGiay = value;
					this.SendPropertyChanged("SoDuThoiGianGiay");
					this.OnSoDuThoiGianGiayChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TongTienDaNap", DbType="Decimal(18,2)")]
		public System.Nullable<decimal> TongTienDaNap
		{
			get
			{
				return this._TongTienDaNap;
			}
			set
			{
				if ((this._TongTienDaNap != value))
				{
					this.OnTongTienDaNapChanging(value);
					this.SendPropertyChanging();
					this._TongTienDaNap = value;
					this.SendPropertyChanged("TongTienDaNap");
					this.OnTongTienDaNapChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TongGiayDaMua", DbType="Float")]
		public System.Nullable<double> TongGiayDaMua
		{
			get
			{
				return this._TongGiayDaMua;
			}
			set
			{
				if ((this._TongGiayDaMua != value))
				{
					this.OnTongGiayDaMuaChanging(value);
					this.SendPropertyChanging();
					this._TongGiayDaMua = value;
					this.SendPropertyChanged("TongGiayDaMua");
					this.OnTongGiayDaMuaChanged();
				}
			}
		}
